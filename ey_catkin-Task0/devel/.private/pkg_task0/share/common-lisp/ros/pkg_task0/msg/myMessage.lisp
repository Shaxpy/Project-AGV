...
(cl:defmethod cl:initialize-instance :after ((m <myMessage>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'myMessage)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pkg_task0-msg:<myMessage> is deprecated: use pkg_task0-msg:myMessage instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <myMessage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pkg_task0-msg:id-val is deprecated.  Use pkg_task0-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <myMessage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pkg_task0-msg:name-val is deprecated.  Use pkg_task0-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'temperature-val :lambda-list '(m))
(cl:defmethod temperature-val ((m <myMessage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pkg_task0-msg:temperature-val is deprecated.  Use pkg_task0-msg:temperature instead.")
  (temperature m))

(cl:ensure-generic-function 'humidity-val :lambda-list '(m))
(cl:defmethod humidity-val ((m <myMessage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pkg_task0-msg:humidity-val is deprecated.  Use pkg_task0-msg:humidity instead.")
  (humidity m))
