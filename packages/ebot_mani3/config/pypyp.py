...
# Embedded file name: task5_spawn_models.py
# Compiled at: 2021-01-11 15:37:14
import rospy
import time
...
def pantry_items_pose():
    ...
    p_y_position = [-0.86, -1.08, -0.748, -
                    0.956, -1.23, -1.045, -1.24, -1.143, -1.157]
...
if _name_ == '_main_':
    ...
    p_req1 = create_model_request(
        sdf_model1, 'coke_can', pantry_pose1[0], pantry_pose1[1], pantry_pose1[2], pantry_pose1[3], pantry_pose1[4], pantry_pose1[5])
    spawn_srv.call(p_req1)
    rospy.loginfo('Spawning water_glass')
    p_req2 = create_model_request(
        sdf_model8, 'water_glass', pantry_pose2[0], pantry_pose2[1], pantry_pose2[2], pantry_pose2[3], pantry_pose2[4], pantry_pose2[5])
    ...
    i_req1 = create_model_request(
        sdf_model5, 'adhesive', in_pose1[0], in_pose1[1], in_pose1[2], in_pose1[3], in_pose1[4], in_pose1[5])
    spawn_srv.call(i_req1)
    rospy.loginfo('Spawning glue')
    i_req2 = create_model_request(
        sdf_model2, 'glue', in_pose2[0], in_pose2[1], in_pose2[2], in_pose2[3], in_pose2[4], in_pose2[5])
    spawn_srv.call(i_req2)
    rospy.loginfo('Spawning battery')
    i_req3 = create_model_request(
        sdf_model3, 'battery', in_pose3[0], in_pose3[1], in_pose3[2], in_pose3[3], in_pose3[4], in_pose3[5])
    spawn_srv.call(i_req3)
    rospy.loginfo('Spawning FPGA board')
    i_req4 = create_model_request(
        sdf_model6, 'FPGA_board', in_pose4[0], in_pose4[1], in_pose4[2], in_pose4[3], in_pose4[4], in_pose4[5])
    spawn_srv.call(i_req4)
    rospy.loginfo('Spawning Pair of wheels package')
    i_req5 = create_model_request(
        sdf_model4, 'robot_wheels', in_pose5[0], in_pose5[1], in_pose5[2], in_pose5[3], in_pose5[4], in_pose5[5])
    spawn_srv.call(i_req5)
    rospy.loginfo('Spawning eYFi board')
    i_req6 = create_model_request(
        sdf_model7, 'eYFi_board', in_pose6[0], in_pose6[1], in_pose6[2], in_pose6[3], in_pose6[4], in_pose6[5])
    spawn_srv.call(i_req6)
    pose1, pose2, pose3 = random_model_pose(
        8.108564, 3.239278, 7.971279, 3.393995, 7.84, 3.24)
    rospy.loginfo('Spawning box2')
    req1 = create_model_request(
        sdf_model3, 'battery2', pose2[0], pose2[1], pose2[2], pose2[3], pose2[4], pose2[5])
    spawn_srv.call(req1)
    rospy.loginfo('Spawning glue')
    req2 = create_model_request(
        sdf_model2, 'glue2', pose3[0], pose3[1], pose3[2], pose3[3], pose3[4], pose3[5])
    spawn_srv.call(req2)
    rospy.loginfo('Spawning adhesive')
    req3 = create_model_request(
        sdf_model5, 'adhesive2', pose1[0], pose1[1], pose1[2], pose1[3], pose1[4], pose1[5])
    spawn_srv.call(req3)
