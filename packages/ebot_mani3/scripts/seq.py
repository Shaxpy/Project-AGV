    ...
    while not rospy.is_shutdown():
        try:
            ...
            trans1 = tfbuffer.lookup_transform(
                'ebot_base', object_number[0] , rospy.Time()) or tfbuffer.lookup_transform(
                'ebot_base', object_number[1], rospy.Time()) or tfbuffer.lookup_transform(
                'ebot_base', object_number[2], rospy.Time()) 
...
if __name__ == '__main__':
    try:
        ...
        coke = object_coordinates(['object_53','object_54','object_54'])
        print coke   
